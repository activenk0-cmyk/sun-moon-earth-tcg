...
export const CARDS = [
  ...
  // ===== 3コスト マジック（号令） =====
  {
    ...
    faction: "sun",
    name: "太陽の号令",
    text: "スタッツ3のキャラクター・トークンを2体、自分の場に出す（場の空きが足りない場合は出せる分だけ）。",
  },
  {
    id: "moon_order",
    slot: "3b",
  ...
  },
  {
    ...
    name: "地球のアルベール",
    stat: 7,
    text: "召喚時、自分の生贄置き場にあるコスト7以下のキャラクターのうち最もコストが高いものと同名のトークンを1体、自分の場に出す（該当するキャラクターがいない場合は何も起こらない）。このトークンは元のカードの能力を持つが、召喚時効果は発動しない。",
    keywords: [],
  },
  ...
  },
  {
    ...
    faction: "earth",
    name: "地球の審判",
    text: "スタッツ6のキャラクター・トークンを2体、自分の場に出す（場の空きが足りない場合は出せる分だけ）。その後、自分のキャラクター全員は永続的にディフェンダーを得る。",
  },
